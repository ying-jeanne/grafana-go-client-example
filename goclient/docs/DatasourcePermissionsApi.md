...
------------- | ------------- | -------------
[**DeletePermissions**](DatasourcePermissionsApi.md#DeletePermissions) | **Delete** /datasources/{datasourceId}/permissions/{permissionId} | Remove permission for a data source.
[**DisablePermissions**](DatasourcePermissionsApi.md#DisablePermissions) | **Post** /datasources/{datasourceId}/disable-permissions | Disable permissions for a data source.
[**EnablePermissions**](DatasourcePermissionsApi.md#EnablePermissions) | **Post** /datasources/{datasourceId}/enable-permissions | Enable permissions for a data source.
[**GetPermissions**](DatasourcePermissionsApi.md#GetPermissions) | **Get** /datasources/{datasourceId}/permissions | Get permissions for a data source.
